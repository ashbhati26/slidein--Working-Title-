              ...
              <>
                <button
                  ...
                  style={{
                    ...
                    color: "var(--ink-2)", height: 44, display: "flex",
        ...
        >
          {NAV_LINKS.map((l) => (
            <a
              ...
              onClick={() => setMenuOpen(false)}
              style={{
                display: "block", padding: "12px 0", fontSize: 17,
                fontWeight: 400, color: "var(--ink-1)",
                borderBottom: "0.5px solid var(--rule)", letterSpacing: "-0.02em",
              }}
            >
              {l.label}
            </a>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 20 }}>
            <button
              ...
              style={{
                ...
                border: "1px solid var(--rule-md)", background: "transparent",
                fontSize: 15, fontWeight: 400, color: "var(--ink-1)", cursor: "pointer",
              }}
            >
              Sign in
            </button>
