    ...
    <div>
      ...
      >
        {triggerType === "ig_comment"
          ? "When someone comments this keyword on your post, Svation sends them a DM instantly."
          : "When someone sends this keyword, Svation replies instantly."}
      </p>
      ...
      <div style={{ marginBottom: 18 }}>
          ...
          >
            {keywords.map((kw) => (
              ...
              >
                {kw}
                <button
                  onClick={() => onKeywords(keywords.filter((k) => k !== kw))}
                  style={{
                    background: "none",
                    border: "none",
                    cursor: "pointer",
        ...
        <div style={{ display: "flex", gap: 7 }}>
          ...
          <button
            ...
            style={{
              ...
              display: "flex",
              alignItems: "center",
              opacity: !input.trim() || !canAddMore ? 0.4 : 1,
            }}
          >
            <Plus size={13} />
          </button>
        ...
        {!isPaid && (
          <p style={{ fontSize: 11, color: "var(--ink-3)", marginTop: 5 }}>
            Free plan: 1 keyword. Upgrade to Creator for multiple keywords +
            fuzzy matching.
          </p>
        )}
      </div>
            ...
            {MATCH_OPTIONS.map((opt) => (
              <button
                ...
                style={{
                  ...
                  background:
                    matchType === opt.v ? "var(--accent-muted)" : "var(--bg)",
              ...
              >
                <p
                  style={{
                    ...
                    fontWeight: 500,
                    color:
                      matchType === opt.v ? "var(--accent)" : "var(--ink-1)",
                    marginBottom: 2,
                  }}
                >
                  {opt.l}
